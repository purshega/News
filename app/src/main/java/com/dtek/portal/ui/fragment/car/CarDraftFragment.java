...
import com.dtek.portal.ui.adapter.car.CarDraftAdapter;
...
import static com.dtek.portal.Const.HTTP.CAR_CAT_DRAFT;

public class CarDraftFragment extends Fragment implements BaseCarAdapter.OrderCarListener {

    private static final String TAG = "CarDraftFragment";
    ...
    private void loadData() {
        ...
        RestManager.getApi()
                .getListOrderCar(map, CAR_CAT_DRAFT)
...
//                        }
    ...
    private void setItemsToList() {
        ...
        // создаем адаптер
        CarDraftAdapter draftAdapter = new CarDraftAdapter(mCarOrderList);
        draftAdapter.setOrderCarListener(this); // слушатель интерфейса
