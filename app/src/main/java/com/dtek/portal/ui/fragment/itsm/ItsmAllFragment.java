...
import static com.dtek.portal.Const.HTTP.ITSM_FILE_ALL;
import static com.dtek.portal.Const.HTTP.ITSM_KEY_RESPONSE;
import static com.dtek.portal.Const.HTTP.ITSM_KEY_URL;
import static com.dtek.portal.Const.HTTP.ITSM_URL_ALL;

public class ItsmAllFragment extends Fragment implements BaseItsmAdapter.ItServiceListener {

    private static final String TAG = "ItsmAllFragment";
...
//                                break;
    ...
    protected Map<String, String> getHeaderMap() {
        ...
        map.put(ITSM_KEY_URL, ITSM_URL_ALL + PreferenceUtils.getLogin());
        map.put(ITSM_KEY_RESPONSE, ITSM_FILE_ALL);
        return map;
    }
