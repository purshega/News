...
import static com.dtek.portal.Const.HTTP.CAR_CAT_ACTIVE;

public class CarActiveFragment extends Fragment implements BaseCarAdapter.OrderCarListener {

    private static final String TAG = "CarActiveFragment";
    ...
    private void loadData() {
        ...
        RestManager.getApi()
                .getListOrderCar(map, CAR_CAT_ACTIVE)
    ...
    private void setItemsToList() {
        ...
        // создаем адаптер
        BaseCarAdapter activeAdapter = new BaseCarAdapter(mCarOrderList);
        activeAdapter.setOrderCarListener(this); // слушатель интерфейса
