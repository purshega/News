...
import static com.dtek.portal.Const.HTTP.CAR_CAT_ALL;

public class CarAllFragment extends Fragment implements BaseCarAdapter.OrderCarListener {

    private static final String TAG = "CarAllFragment";
    ...
    private void loadData() {
        ...
        RestManager.getApi()
                .getListOrderCar(map, CAR_CAT_ALL)
...
//                        }
    ...
    private void setItemsToList() {
        ...
        // создаем адаптер
        BaseCarAdapter allAdapter = new BaseCarAdapter(mCarOrderList);
        allAdapter.setOrderCarListener(this); // слушатель интерфейса
