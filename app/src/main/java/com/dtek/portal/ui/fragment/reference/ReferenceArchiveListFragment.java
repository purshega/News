...
import static com.dtek.portal.Const.References.REFERENCE_FILE_GET_ARCHIVE;
import static com.dtek.portal.Const.References.REFERENCE_URL_ARCHIVE;

public class ReferenceArchiveListFragment  extends ItsmAllFragment {

    @NonNull
    protected Map<String, String> getHeaderMap() {
        Map<String, String> map = new HashMap<>();
        map.put(API_AUTHORITY, PreferenceUtils.getToken());
        map.put(ITSM_KEY_URL, REFERENCE_URL_ARCHIVE + PreferenceUtils.getLogin());
        map.put(ITSM_KEY_RESPONSE, REFERENCE_FILE_GET_ARCHIVE);
        return map;
    }
