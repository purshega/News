...
public class CarDraftFragment_ViewBinding implements Unbinder {
  private CarDraftFragment target;

  @UiThread
  public CarDraftFragment_ViewBinding(CarDraftFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CarDraftFragment target = this.target;
