...
public class TabBusinessTripFragment_ViewBinding implements Unbinder {
  private TabBusinessTripFragment target;

  private View view2131361980;

  @UiThread
  public TabBusinessTripFragment_ViewBinding(final TabBusinessTripFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TabBusinessTripFragment target = this.target;
