...
public class ItsmActiveFragment_ViewBinding implements Unbinder {
  private ItsmActiveFragment target;

  @UiThread
  public ItsmActiveFragment_ViewBinding(ItsmActiveFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ItsmActiveFragment target = this.target;
