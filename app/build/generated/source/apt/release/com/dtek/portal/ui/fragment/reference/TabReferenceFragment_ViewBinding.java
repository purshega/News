...
public class TabReferenceFragment_ViewBinding implements Unbinder {
  private TabReferenceFragment target;

  private View view2131361980;

  @UiThread
  public TabReferenceFragment_ViewBinding(final TabReferenceFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TabReferenceFragment target = this.target;
