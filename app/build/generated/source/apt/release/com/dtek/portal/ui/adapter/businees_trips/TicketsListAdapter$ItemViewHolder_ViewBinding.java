...
public class TicketsListAdapter$ItemViewHolder_ViewBinding implements Unbinder {
  private TicketsListAdapter.ItemViewHolder target;

  @UiThread
  public TicketsListAdapter$ItemViewHolder_ViewBinding(TicketsListAdapter.ItemViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TicketsListAdapter.ItemViewHolder target = this.target;
