...
public class CarActiveFragment_ViewBinding implements Unbinder {
  private CarActiveFragment target;

  @UiThread
  public CarActiveFragment_ViewBinding(CarActiveFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CarActiveFragment target = this.target;
