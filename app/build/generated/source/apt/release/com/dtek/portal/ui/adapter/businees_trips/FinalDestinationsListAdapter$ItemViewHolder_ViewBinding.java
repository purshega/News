...
public class FinalDestinationsListAdapter$ItemViewHolder_ViewBinding implements Unbinder {
  private FinalDestinationsListAdapter.ItemViewHolder target;

  @UiThread
  public FinalDestinationsListAdapter$ItemViewHolder_ViewBinding(FinalDestinationsListAdapter.ItemViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FinalDestinationsListAdapter.ItemViewHolder target = this.target;
