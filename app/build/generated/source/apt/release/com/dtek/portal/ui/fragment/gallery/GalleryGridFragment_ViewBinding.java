...
public class GalleryGridFragment_ViewBinding implements Unbinder {
  private GalleryGridFragment target;

  @UiThread
  public GalleryGridFragment_ViewBinding(GalleryGridFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    GalleryGridFragment target = this.target;
