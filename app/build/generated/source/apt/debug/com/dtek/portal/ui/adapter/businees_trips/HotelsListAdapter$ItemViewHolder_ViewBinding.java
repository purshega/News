...
public class HotelsListAdapter$ItemViewHolder_ViewBinding implements Unbinder {
  private HotelsListAdapter.ItemViewHolder target;

  @UiThread
  public HotelsListAdapter$ItemViewHolder_ViewBinding(HotelsListAdapter.ItemViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    HotelsListAdapter.ItemViewHolder target = this.target;
