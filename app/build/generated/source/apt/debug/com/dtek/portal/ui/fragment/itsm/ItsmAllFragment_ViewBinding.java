...
public class ItsmAllFragment_ViewBinding implements Unbinder {
  private ItsmAllFragment target;

  @UiThread
  public ItsmAllFragment_ViewBinding(ItsmAllFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ItsmAllFragment target = this.target;
