...
public class VacationSubordinateFragment_ViewBinding implements Unbinder {
  private VacationSubordinateFragment target;

  @UiThread
  public VacationSubordinateFragment_ViewBinding(VacationSubordinateFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    VacationSubordinateFragment target = this.target;
