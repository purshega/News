...
public class VacationHistoryFragment_ViewBinding implements Unbinder {
  private VacationHistoryFragment target;

  @UiThread
  public VacationHistoryFragment_ViewBinding(VacationHistoryFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    VacationHistoryFragment target = this.target;
