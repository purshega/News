...
public class ListTwoLineFragment_ViewBinding implements Unbinder {
  private ListTwoLineFragment target;

  @UiThread
  public ListTwoLineFragment_ViewBinding(ListTwoLineFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ListTwoLineFragment target = this.target;
